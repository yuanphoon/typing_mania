...
// ---------------FUNCTIONS------------
  ...
  function getTimeElapsed() {
    ...
    timeElapsed = currentTimeMs - startTimeMs - totalPaused
    timeElapsedS = timeElapsed/1000;
  }

  function workWordsPerMinute() {
  ...
  function writeMaxWordsPerMinute() {
  ...
  function resumeEvent() {
    ...
    durationPaused = resumeTimeMs - pauseTimeMs;
    totalPaused += durationPaused;
  }
...
// ---------------TRIGGERS-------------
  ...
  $('.answer').keydown(function(e) {
    ...
    // Behaviour when return is pressed in the input box
    else if(e.which == 13) {
      clearEvent();
    }
